...
// in ACM TOMS, {VOL 37, ISSUE 4, (February 2011)} (C) ACM, 2011. http://doi.acm.org/10.1145/1916461.1916469
  ...
  namespace mpfr
  {
    ...
    public:
      ...
      static const std::int64_t ef_max_exp   = static_cast<std::int64_t>((std::numeric_limits<std::int32_t>::max)() / static_cast<signed long>(2L)); // TBD: Ensure that (std::int64_t >= long)
      static const std::int64_t ef_min_exp   = static_cast<std::int64_t>((std::numeric_limits<std::int32_t>::min)() / static_cast<signed long>(2L)); // TBD: Ensure that (std::int64_t >= long)

      static const std::int64_t ef_max_exp10 = static_cast<std::int64_t>((static_cast<std::int64_t>(ef_max_exp) * 301LL) / 1000LL);
      static const std::int64_t ef_min_exp10 = static_cast<std::int64_t>((static_cast<std::int64_t>(ef_min_exp) * 301LL) / 1000LL);
