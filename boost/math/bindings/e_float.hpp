...
// See https://github.com/ckormanyos/::e_float-2021
  ...
  namespace std
  {
    ...
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::is_specialized;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::is_signed;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::is_integer;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::is_exact;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::is_bounded;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::is_modulo;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::is_iec559;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr int  std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::digits;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr int  std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::digits10;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr int  std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::max_digits10;

    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr std::int64_t std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::max_exponent;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr std::int64_t std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::max_exponent10;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr std::int64_t std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::min_exponent;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr std::int64_t std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::min_exponent10;

    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr int                     std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::radix;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr std::float_round_style  std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::round_style;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool                    std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::has_infinity;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool                    std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::has_quiet_NaN;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool                    std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::has_signaling_NaN;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr std::float_denorm_style std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::has_denorm;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool                    std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::has_denorm_loss;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool                    std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::traps;
    template<const boost::multiprecision::expression_template_option ExpressionTemplates> constexpr bool                    std::numeric_limits<boost::multiprecision::number<boost::math::ef::e_float, ExpressionTemplates>>::tinyness_before;
